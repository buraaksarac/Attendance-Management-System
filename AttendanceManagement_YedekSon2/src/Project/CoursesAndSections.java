 ...
 * @author Burak
 */
public class CoursesAndSections extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Courses and Sections");
        kGradientPanel1.add(jLabel2);
        jLabel2.setBounds(380, 20, 230, 40);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/BackArrow.png"))); // NOI18N
    ...
    public void arr() {
        ...
        for(int j = 0; j<myArr.length; j++) {
            if(j+2<myArr.length) {
                a = new JLabel();
                a.setText(myArr[j] + " : " + myArr[j+1] + ", " + myArr[j+2]);
    ...
    public void init() {
        ...
        jLabel2.setText("Courses and Sections");
        kGradientPanel1.add(jLabel2);
        jLabel2.setBounds(370, 20, 230, 40);
        arr();
        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoursesAndSections.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new CoursesAndSections().setVisible(true);
        });
    }
